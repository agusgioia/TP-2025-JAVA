...
public class UserController {
    ...
    @RequestMapping(value = "/{id}/borrarViaje/{idViaje}", method = RequestMethod.DELETE)
    public ResponseEntity EliminarViaje(@PathVariable(value = "id") String id, @PathVariable(value = "idViaje") Integer idViaje){
        return new ResponseEntity(service.EliminarViaje(id,idViaje),HttpStatus.OK);
    }
}
